...
var _showChampionsJs = require("./showChampions.js");
document.addEventListener("DOMContentLoaded", ()=>{
    const logo = document.getElementById("logo");
    const mainContainer = document.getElementById("main");
    // Evento al hacer clic en el logo
    logo.addEventListener("click", ()=>{
        fetch("assets/data/champion.json").then((response)=>{
...
},{"./loadData.js":"jXUIQ","./showChampions.js":"1YVv6"}],"jXUIQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cargarDatos", ()=>cargarDatos);
...
},{}],"1YVv6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mostrarCampeones", ()=>mostrarCampeones);
function mostrarCampeones(data, container) {
    if (!data) {
